...
if ( $max_value && $min_value === $max_value ) {
	...
	?>
	<div class="quantity counter d-flex justify-content-center my-4">
		<?php do_action( 'woocommerce_before_quantity_input_field' ); ?>
        <span class="increase"><i class="icon-plus-outline"></i></span>
		<input
			type="number"
			id="<?php echo esc_attr( $input_id ); ?>"
			class="input-counter <?php echo esc_attr( join( ' ', (array) $classes ) ); ?>"
